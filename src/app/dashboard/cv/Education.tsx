import { CvEducation } from '@/interface'

export const Education = ({ data }: { data: CvEducation[] }) => {
  return (
          ...
          <div className="space-y-16">
            {data.map((e, i) => (
              ...
              >
                ...
                <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400">{e.description}</p>
              </article>
            ))}
          </div>
        </div>
